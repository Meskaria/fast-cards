...
import { CreateUserUseCase } from 'apps/api/src/app/modules/user/use-cases/create-user/create-user.use-case';
import { USER_ACCESS } from 'apps/api/src/app/modules/user/domain/user';
  ...
  describe('execute', () => {
    ...
    it('should return left with error if user exists', async () => {
      jest
        ...
        .mockImplementation((product?: string) => Promise.resolve(true));
